...
public:
	...
	double* GetRealArray(std::string section, std::string name, double default_value, int ArrCount) const;
...
inline double* INIReader::GetRealArray(string section, string name, double default_value, int ArrCount) const
{
	string s = Get(section, name, "");
	double *n;
	n = new double[ArrCount]; for (int i = 0; i < ArrCount; i++) { n[i] = 0; }
